...
func TestRepository(t *testing.T) {
	...
	// test with proper parameters
	resp, err := repo.CreateRequest(t.Context(), entity.Request{Prompt: "What is the capital of France?", LastId: ""}, "You are a helpfull AI assistant", "gpt-4.1-nano-2025-04-14")
	if err != nil || resp == nil {
