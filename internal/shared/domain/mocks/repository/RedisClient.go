...
func (_mock *MockRedisClient) Set(ctx context.Context, key string, value any, ttl time.Duration) *redis.StatusCmd {
...
func (_c *MockRedisClient_Set_Call) Run(run func(ctx context.Context, key string, value any, ttl time.Duration)) *MockRedisClient_Set_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRedisClient_Set_Call) RunAndReturn(run func(ctx context.Context, key string, value any, ttl time.Duration) *redis.StatusCmd) *MockRedisClient_Set_Call {
	_c.Call.Return(run)
	return _c
}
