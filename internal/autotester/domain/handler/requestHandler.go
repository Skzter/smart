...
func NewAutotesterController(
	...
	if err := assert.NotNil(logger, config, validationService, generationService, tracer); err != nil {
		return nil, err
	}
...
func (a *AutotesterController) HandleChatRequest(c *gin.Context) {
	...
	if err := c.BindJSON(&userRequest); err != nil {
		...
		span.SetStatus(codes.Error, "JSON binding failed")
	...
	if err != nil {
		...
		span.RecordError(frontendError)
		span.SetStatus(codes.Error, "serviceHandler failed")
	...
	span.SetStatus(codes.Ok, "serviceHandler successful")
...
func (a *AutotesterController) HandleUserInfoRequest(c *gin.Context) {
	...
	span.SetStatus(codes.Ok, "autotesterController.HandleUserInfoRequest successful")
