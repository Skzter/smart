...
import (
	...
	autotesterOpenAIService "gitlab.dit.htwk-leipzig.de/projekt2025-w-llm-unterstuetztes-autotesting-fuer-moderne-web-frontends/smart/internal/autotester/domain/service"
...
func InitializeApp(cfg *config.Config) (*gin.Engine, error) {
	wire.Build(
		...
		autotesterOpenAIService.NewValidatePromptService,
		autotesterOpenAIService.NewGeneratePromptService,
