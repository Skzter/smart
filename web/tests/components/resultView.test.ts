...
describe("ResultView", () => {
    it("renders the main container", () => {
        ...
        const mainDiv = container.querySelector('.w-full.h-full.flex.items-center.justify-center.bg-gray-50');
    ...
    it("renders component structure correctly", () => {
        ...
        const mainDiv = container.querySelector('div.w-full.h-full') as HTMLElement;
        const innerDiv = container.querySelector('div.text-center') as HTMLElement;
