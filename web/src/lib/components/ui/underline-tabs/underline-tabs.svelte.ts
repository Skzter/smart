...
class UnderlineTabsTriggerState {
    ...
    onmouseenter(
        e: Parameters<
            NonNullable<TabsPrimitive.TriggerProps["onmouseenter"]>
        >[0],
    ) {
        this.handleFocus();
    ...
    onmouseleave(
        e: Parameters<
            NonNullable<TabsPrimitive.TriggerProps["onmouseleave"]>
        >[0],
    ) {
        this.handleBlur();
    ...
    onblur(
        e: Parameters<NonNullable<TabsPrimitive.TriggerProps["onblur"]>>[0],
    ) {
        this.handleBlur();
